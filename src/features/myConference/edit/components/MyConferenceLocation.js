    ...
    <Grid item container lg={12} spacing={3}>
      <Grid item container lg={12} spacing={3}>
        <Grid item xs={12} sm={6} lg={3}>
          <CustomTextField label={t('Location.Name')} fullWidth value={name ?? emptyString} onChange={onTextBoxChange(handleDispatch('locationName'))} />
        </Grid>
        <Grid item xs={12} sm={6} lg={6}>
          <CustomTextField label={t('Location.Address')} fullWidth value={address ?? emptyString} onChange={onTextBoxChange(handleDispatch('address'))} />
        </Grid>
      </Grid>
      <Grid item container lg={12} spacing={3}>
        <Grid item xs={12} sm={6} lg={3}>
